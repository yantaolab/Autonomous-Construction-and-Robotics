...
Use a real-world housing sales dataset from King County, Washington, to build an interpretable baseline model, enhance model performance through feature engineering, compare two predictive models, and analyze the sources of prediction error within a 60-minute time limit.

# Files description

**A1_Assignment_Questions.docx**: The description of assignment  requirements and the template of the answer sheet.
**A1_Housing_Price_Tutorial.ipynb**: The tutorial materials, in-class activities, and demonstration code used in the session.
**A1_Housing_Price_Tutorial.pptx**: Tutorial slides covering fundamental concepts, the dataset description, and guidance on setting up the computing environment.
**A1_Housing_Price_data.csv**: The dataset used for the demonstration code.
